...
covid_admissions_HSCP_age_totals %>% 
  ...
  labs(x = "Month",
       ...
       title = "HSCP Total COVID admissions per month by age group",
...
covid_admissions_HSCP_age_totals %>% 
  ...
  aes(x = total_admissions_per_month, 
      ...
      colour = age_group)+
  geom_point() +
  labs(x = "Monthly number of COVID admissions",
       y = "Average monthly admissions to hospital in 2018-2019",
       title = "Monthly COVID admissions per age group against the average weekly 
       admissions in previous years",
       subtitle = "COVID: January, 2020 - February, 2022 / 
       Previous years: 2018 - 2019",
       colour = "Age Group") +
...
covid_admissions_HSCP_sex_totals %>% 
  ...
  labs(x = "Month and Year",
       y = "Total COVID Admissions across Health Boards per Month",
       title = "HSCP Total COVID Admissions per Month by Sex", 
       fill = "Sex")+  
  theme_bw()+
  theme(axis.text.x = element_text(angle = 45, hjust = 0.9))
```
...
covid_admissions_HSCP_sex_totals %>% 
  ...
  labs(x = "Month",
       y = "Total COVID Admissions",
       title = "HSCP Monthly COVID admissions by sex",
...
covid_admissions_HSCP_simd_totals %>% 
  ...
  labs(x = "Month",
       y = "Total COVID admissions",
       title = "HSCP Total COVID admissions per month by SIMD Level",
       subtitle = "January, 2020 - February 2022",
       colour = "SIMD Level:
       1 = Most Deprived
       5 = Least Deprived") +
...
covid_admissions_HSCP_simd_totals %>% 
  ...
  labs(x = "Monthly number of COVID admissions",
       y = "Average monthly admissions to hospital in 2018-2019",
       title = "HSCP Monthly COVID admissions against the average weekly 
       admissions in previous years by SIMD Level",
       subtitle = "COVID: January, 2020 to February, 2022 / Previous years: 2018 - 2019",
       colour = "SIMD Level:
       1 = Most Deprived
       5 = Least Deprived") +
