...
Re-trying above graph - still messy but can be looked into.
...
covid_admissions_HB_sex %>% 
  ...
  labs(x = "Month and Year",
       ...
       title = "Total COVID Admissions per Month by Sex", 
       fill = "Sex")+  
  theme_bw()+
  theme(axis.text.x = element_text(angle = 45, hjust = 0.9))
```
...
covid_admissions_HB_sex %>% 
  ...
  labs(x = "Month",
       y = "Total COVID Admissions",
       title = "Monthly COVID admissions by sex",
...
covid_admissions_HB_simd_totals %>% 
  ...
  labs(x = "Month",
       y = "Total COVID admissions",
       title = "Total COVID admissions per month by SIMD Level",
       subtitle = "January, 2020 - February 2022",
       colour = "SIMD Level:
       1 = Most Deprived
       5 = Least Deprived") +
...
covid_admissions_HB_simd_totals %>% 
  ...
  labs(x = "Monthly number of COVID admissions",
       y = "Average monthly admissions to hospital in 2018-2019",
       title = "Monthly COVID admissions against the average weekly 
       admissions in previous yearsby SIMD Level",
       subtitle = "COVID: January, 2020 to February, 2022 / Previous years: 2018 - 2019",
       colour = "SIMD Level") +
  theme_bw()+
  theme(axis.text.x = element_text(angle = 45, hjust = 0.9))
